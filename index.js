...
module.exports = [
  ...
  [0x800002e9, 'DIMI', 'DiminutiveCoin'],
  [0x800002ea, 'PLM', 'Palladium'],
  ...
  [0x80000371, 'AEGS', 'Aegisum'],
  [0x80000373, 'ZBC', 'ZooBC'],
  [0x80000375, 'XCN', 'XCoin'],
  ...
  [0x800003b6, 'CNDT', 'Conduct Protocol'],
  ...
  [0x800007b1, 'MVRK', 'Mavryk Network'],
  [0x800007b9, 'XMX', 'Xuma'],
  ...
  [0x8002e305, 'QUAN', 'Quantus Network'],
  ...
  [0x807c8fc7, 'AFS', 'ANFS'],
  [0x807c8ff9, 'BTCV', 'Bitcoin-Value'],
  [0x805d30b6, 'OSMO', 'Osmosis'],
  [0x80e6b280, 'XDS', 'XDS'],
  [0x8121eb36, 'SEI', 'SEI'],
  [0x814fb1f6, 'DYDX', 'Dydx'],
  [0x814fb1f7, 'INJ', 'Injective'],
